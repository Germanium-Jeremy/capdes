          ...
          <View style={{ flex: 1 }}>
               ...
               >
                    ...
                    <View style={{ position: 'relative' }}>
                         <Text style={{ fontSize: 20, fontWeight: 500, textAlign: 'center', marginTop: 40, color: theme.textColor }}>Login</Text>
                    ...
                    >
                         <Text style={{ fontSize: 18, color: theme.textColor }}>Welcome to <Text style={{ fontSize: 20, fontWeight: 700 }}>CAPDES</Text></Text>
