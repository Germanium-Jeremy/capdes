...
export default function SignupScreen() {
     ...
     const termsOfServices = <Text style={{ color: theme.textColor }}>Agree to our <Link href={'/'} style={{ color: theme.mainColor }}>terms of services</Link> and <Link href={'/'} style={{ color: theme.mainColor }}>privacy policies</Link> </Text>
     const isMechanicOrOwner = <Text style={{ color: theme.textColor }}>Do you have a job as a mechanic for any garage or own a garage?</Text>
     ...
     return (
          <ScrollView style={{ flex: 1 }}>
               ...
               >
                    {/* <Pressable onPress={() => setColorScheme(colorScheme === "light" ? "dark" : "light")} style={styles.buttons}>
                         { <Ionicons name={colorScheme === "light" ? "sunny" : "moon"} size={25} color={colorScheme === "light" ? "black" : "white"} /> }
                    </Pressable> */}
                    <View style={{ position: 'relative' }}>
                         <Text style={{ fontSize: 20, fontWeight: 500, textAlign: 'center', marginTop: 40, color: theme.textColor }}>Sign up</Text>
                    ...
                    >
                         <Text style={{ fontSize: 18, color: theme.textColor }}>Create a <Text style={{ fontSize: 20, fontWeight: 700 }}>CAPDES</Text> account</Text>
                         <View style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 40 }}>
                              ...
                              <View style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                                   <Text style={{ fontSize: 18, color: theme.textColor }}>Password</Text>
                                   <View style={styles.formFields}>
                                        <Ionicons name="key" size={25} color={theme.textColor} />
