     ...
     return (
          ...
          >
               <View style={{ position: 'relative' }}>
                    <Text style={{ fontSize: 20, fontWeight: 500, textAlign: 'center', marginTop: 40, color: theme.secondTextColor }}>Register Mechanic</Text>
               ...
               >
                    <Text style={{ fontSize: 18, color: theme.secondTextColor }}>We require the following info to get you working.</Text>
