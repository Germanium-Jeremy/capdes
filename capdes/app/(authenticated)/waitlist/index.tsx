...
const index = () => {
     ...
     return (
          <>
               <Stack.Screen options={{ header: () => <Header title='Wait List' /> }} />
               ...
               <LinearGradient colors={[
                    ...
                    <Text style={{ color: theme.secondTextColor, fontSize: 20, fontWeight: 600, textAlign: 'center', marginTop: 20 }}>Wait List</Text>
                    ...
                    <View style={styles.flatListContainer}>
                         <View style={styles.mechanic}>
                              ...
                              <View style={{ flexDirection: 'column', gap: 1, width: '100%' }}>
                                   ...
                                   <View style={{ flexDirection: 'row', gap: 10, justifyContent: 'space-between', alignItems: 'center', width: '60%' }}>
                                        <Pressable style={styles.buttons}>
                                             <Text style={styles.textBtn}>Approve</Text>
                                        </Pressable>
                                        <Pressable style={styles.buttons}>
